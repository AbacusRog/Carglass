...
insert into employees (name, annual_wage, working_days_per_year, working_hours_per_day, holiday_entitlement_days) values
  ('Fred', 33000, 253, 8.5, 28),
  ('Thales', 31000, 253, 8.5, 28),
  ('Flynn', 24000, 253, 8.5, 28),
  ('Alfi Gibson', 30000, 253, 8.5, 28)
